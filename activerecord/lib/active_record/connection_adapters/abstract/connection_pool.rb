...
module ActiveRecord
  module ConnectionAdapters
    ...
    # by ActiveRecord queries executing on that thread.  You do not have to explicitly
    # pass the checked-out connection your Rails models or queries, for example.
    #
    # == Options
    #
